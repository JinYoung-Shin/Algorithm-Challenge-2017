...
## 4.4-dp-basis/2169-robot-control
...
## 4.4-dp-basis/12969-abc
dp[i][a][b][k] => 길이 i, A가 a개, B가 b개, C가 i-a-b개에 조건 만족하는 쌍이 k개인 문자열의 가능 여부
로 점화식을 세워서 해당 인자 N, K값에 맞게 문자열을 만들 수 있는지 아닌 지를
확인한 뒤, 제귀로 backtracking 방식으로 문자열을 만들어내면 된다.